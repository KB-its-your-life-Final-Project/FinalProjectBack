...
public enum ErrorCode implements ResponseCode{
    ...
    INVALID_VERIFICATION_CODE(1007, "인증번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
    ...
    INVALID_LOGIN_TYPE(1008, "올바르지 않은 로그인 접근입니다.", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(1009, "비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
