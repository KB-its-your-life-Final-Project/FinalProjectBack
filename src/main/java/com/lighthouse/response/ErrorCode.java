...
public enum ErrorCode implements ResponseCode{
    ...
    KAKAO_REGISTER_LOGIN_FAIL(1011, "카카오 회원가입 또는 로그인에 실패하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    GOOGLE_REGISTER_LOGIN_FAIL(1012, "구글 회원가입 또는 로그인에 실패하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    INVALID_LOGIN_TYPE(1013, "올바르지 않은 로그인 접근입니다.", HttpStatus.BAD_REQUEST),
    INVALID_PASSWORD(1014, "비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
    EMAIL_LOGIN_FAIL(1015, "이메일 로그인에 실패하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    MEMBER_LOGOUT_FAIL(1016, "로그아웃에 실패하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    UNAUTHORIZED(1017, "인증되지 않은 사용자입니다.", HttpStatus.UNAUTHORIZED),
    INVALID_UPDATE_TYPE(1018, "올바르지 않은 회원 정보 수정 요청입니다.", HttpStatus.BAD_REQUEST),
    ...
    MEMBER_UPDATE_FAIL(1021, "회원 정보 수정에 실패하였습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    INVALID_FILE_EMPTY(1022, "파일이 비어있습니다.", HttpStatus.BAD_REQUEST),
    INVALID_FILE_SIZE(1023, "파일이 5MB를 초과합니다.", HttpStatus.BAD_REQUEST),
    INVALID_FILE_TYPE(1024, "지원하지 않는 파일 형식입니다.", HttpStatus.BAD_REQUEST),
