...
public enum ErrorCode implements ResponseCode{
    ...
    // HomeRegister
    HOME_REGISTER_FAIL(6001, "집 정보 등록에 실패했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
    ESTATE_NOT_FOUND_BY_COORDINATES(6002, "해당 위치의 부동산 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    UNAUTHORIZED_USER(6003, "로그인이 필요합니다.", HttpStatus.UNAUTHORIZED),
    //Server Error
